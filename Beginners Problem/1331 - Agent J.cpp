...
int main() {
    ...
    Test {
        ...
        double theta1 = acos((Sqr(b) + Sqr(c) - Sqr(a)) / (2.0 * b * c));
        double theta2 = acos((Sqr(c) + Sqr(a) - Sqr(b)) / (2.0 * a * c));
        double theta3 = acos((Sqr(a) + Sqr(b) - Sqr(c)) / (2.0 * a * b));

        double cir_area1 = 0.5 * Sqr(r1) * theta1;
        double cir_area2 = 0.5 * Sqr(r2) * theta2;
        double cir_area3 = 0.5 * Sqr(r3) * theta3;

        double tot = cir_area1 + cir_area2 + cir_area3;

        double inside_area = tri_area - tot;
        Precision(10);
        cout << "Case " << tc << ": ";
        cout << inside_area << "\n";
    }
